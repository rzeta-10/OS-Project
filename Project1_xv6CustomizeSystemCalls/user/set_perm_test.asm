...
user/_set_perm_test:     file format elf64-littleriscv
...
int main(int argc, char *argv[])
{
  ...
  16:	8ae50513          	addi	a0,a0,-1874 # 8c0 <malloc+0xfe>
  1a:	6f4000ef          	jal	70e <printf>
        exit(1);
  1e:	4505                	li	a0,1
  20:	2b6000ef          	jal	2d6 <exit>
  24:	e426                	sd	s1,8(sp)
  26:	e04a                	sd	s2,0(sp)
  28:	84ae                	mv	s1,a1
    }
    ...
    int pid = atoi(argv[1]);
  2a:	6588                	ld	a0,8(a1)
  2c:	1b4000ef          	jal	1e0 <atoi>
  30:	892a                	mv	s2,a0
    int perm_flags = atoi(argv[2]);
  32:	6888                	ld	a0,16(s1)
  34:	1ac000ef          	jal	1e0 <atoi>
  38:	84aa                	mv	s1,a0

    if (set_perm(pid, perm_flags) < 0) {
  3a:	85aa                	mv	a1,a0
  3c:	854a                	mv	a0,s2
  3e:	350000ef          	jal	38e <set_perm>
  ...
  4e:	8d650513          	addi	a0,a0,-1834 # 920 <malloc+0x15e>
  52:	6bc000ef          	jal	70e <printf>
    }

    exit(0);
  56:	4501                	li	a0,0
  58:	27e000ef          	jal	2d6 <exit>
        printf("Error: Unable to set permissions for process %d\n", pid);
  5c:	85ca                	mv	a1,s2
  5e:	00001517          	auipc	a0,0x1
  62:	88a50513          	addi	a0,a0,-1910 # 8e8 <malloc+0x126>
  66:	6a8000ef          	jal	70e <printf>
  6a:	b7f5                	j	56 <main+0x56>
...
0000000000000136 <gets>:
 ...
 15c:	0344d663          	bge	s1,s4,188 <gets+0x52>
 160:	4605                	li	a2,1
 162:	faf40593          	addi	a1,s0,-81
 166:	4501                	li	a0,0
 168:	186000ef          	jal	2ee <read>
 16c:	00a05e63          	blez	a0,188 <gets+0x52>
 170:	faf44783          	lbu	a5,-81(s0)
 174:	00f90023          	sb	a5,0(s2)
 178:	01578763          	beq	a5,s5,186 <gets+0x50>
 17c:	0905                	addi	s2,s2,1
 17e:	fd679de3          	bne	a5,s6,158 <gets+0x22>
 182:	89a6                	mv	s3,s1
 184:	a011                	j	188 <gets+0x52>
 186:	89a6                	mv	s3,s1
...
00000000000001a6 <stat>:
 ...
 1b0:	892e                	mv	s2,a1
 1b2:	4581                	li	a1,0
 1b4:	162000ef          	jal	316 <open>
 1b8:	02054263          	bltz	a0,1dc <stat+0x36>
 1bc:	e426                	sd	s1,8(sp)
 1be:	84aa                	mv	s1,a0
 1c0:	85ca                	mv	a1,s2
 1c2:	16c000ef          	jal	32e <fstat>
 1c6:	892a                	mv	s2,a0
 1c8:	8526                	mv	a0,s1
 1ca:	134000ef          	jal	2fe <close>
 1ce:	64a2                	ld	s1,8(sp)
 1d0:	854a                	mv	a0,s2
...
0000000000000228 <memmove>:
 ...
 24c:	fef71ae3          	bne	a4,a5,240 <memmove+0x18>
 250:	6422                	ld	s0,8(sp)
...
000000000000037e <fork2>:
 37e:	48dd                	li	a7,23
 380:	00000073          	ecall
 384:	8082                	ret

0000000000000386 <get_ppid>:
 386:	48e1                	li	a7,24
 388:	00000073          	ecall
 38c:	8082                	ret

000000000000038e <set_perm>:
 38e:	48e5                	li	a7,25
 390:	00000073          	ecall
 394:	8082                	ret
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	57e50513          	addi	a0,a0,1406 # 950 <digits>
 3da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 46a:	26090863          	beqz	s2,6da <vprintf+0x27e>
 ...
 4b2:	20090c63          	beqz	s2,6ca <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
 ...
 4d4:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 4d8:	03878f63          	beq	a5,s8,516 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
 4dc:	05978963          	beq	a5,s9,52e <vprintf+0xd2>
 ...
 4e4:	0ee78363          	beq	a5,a4,5ca <vprintf+0x16e>
 ...
 4ec:	12e78563          	beq	a5,a4,616 <vprintf+0x1ba>
 ...
 4f4:	14e78a63          	beq	a5,a4,648 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
 4f8:	07300713          	li	a4,115
 4fc:	18e78a63          	beq	a5,a4,690 <vprintf+0x234>
 ...
 504:	04e79563          	bne	a5,a4,54e <vprintf+0xf2>
        putc(fd, '%');
 508:	02500593          	li	a1,37
 50c:	855a                	mv	a0,s6
 50e:	e89ff0ef          	jal	396 <putc>
 ...
 522:	855a                	mv	a0,s6
 524:	e91ff0ef          	jal	3b4 <printint>
 528:	8bca                	mv	s7,s2
      state = 0;
 52a:	4981                	li	s3,0
 52c:	bfad                	j	4a6 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
 52e:	06400793          	li	a5,100
 532:	02f68963          	beq	a3,a5,564 <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 536:	06c00793          	li	a5,108
 53a:	04f68263          	beq	a3,a5,57e <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
 53e:	07500793          	li	a5,117
 542:	0af68063          	beq	a3,a5,5e2 <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
 546:	07800793          	li	a5,120
 54a:	0ef68263          	beq	a3,a5,62e <vprintf+0x1d2>
        putc(fd, '%');
 54e:	02500593          	li	a1,37
 552:	855a                	mv	a0,s6
 554:	e43ff0ef          	jal	396 <putc>
        putc(fd, c0);
 558:	85ca                	mv	a1,s2
 55a:	855a                	mv	a0,s6
 ...
 57a:	4981                	li	s3,0
        i += 1;
 57c:	b72d                	j	4a6 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 57e:	06400793          	li	a5,100
 582:	02f60763          	beq	a2,a5,5b0 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 586:	07500793          	li	a5,117
 58a:	06f60963          	beq	a2,a5,5fc <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 58e:	07800793          	li	a5,120
 592:	faf61ee3          	bne	a2,a5,54e <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 5d6:	855a                	mv	a0,s6
 5d8:	dddff0ef          	jal	3b4 <printint>
 5dc:	8bca                	mv	s7,s2
      state = 0;
 5de:	4981                	li	s3,0
 5e0:	b5d9                	j	4a6 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 622:	855a                	mv	a0,s6
 624:	d91ff0ef          	jal	3b4 <printint>
 628:	8bca                	mv	s7,s2
      state = 0;
 62a:	4981                	li	s3,0
 62c:	bdad                	j	4a6 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 6b0:	8bce                	mv	s7,s3
      state = 0;
 6b2:	4981                	li	s3,0
 6b4:	bbcd                	j	4a6 <vprintf+0x4a>
          s = "(null)";
 6b6:	00000917          	auipc	s2,0x0
 6ba:	29290913          	addi	s2,s2,658 # 948 <malloc+0x186>
        for(; *s; s++)
